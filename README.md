About biopandas-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/biopandas-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3696&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/biopandas-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `biopandas` can be installed with `conda`:
...
```
mamba install biopandas
```

It is possible to list all of the versions of `biopandas` available on your platform with `conda`:
...
```
mamba search biopandas --channel conda-forge
```
...
mamba repoquery search biopandas --channel conda-forge

# List packages depending on `biopandas`:
mamba repoquery whoneeds biopandas --channel conda-forge

# List dependencies of `biopandas`:
mamba repoquery depends biopandas --channel conda-forge
```
